...
## Por Terminal:
        ...
        $ ssh -i ~/st180020192.pem hadoop@emr1.emontoya.ml
...
También están en Amazon S3:      s3://emontoyast1800public/datasets
...
* archivos en Amazon s3:
    ...
    user@master$ hadoop distcp s3://emontoyast1800public/datasets/airlines.csv /tmp/
